        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <img 
                src="https://cdn.poehali.dev/files/bb1a42d7-09d1-4b78-97e3-ef9134486130.jpg" 
                alt="Репетитор математики Зухра Ильясовна"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-gray-600">
                  "Зухра Ильясовна помогла моему сыну подтянуть алгебру за полгода. 
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-gray-600">
                  "Математика стала моим любимым предметом! Зухра Ильясовна объясняет сложные темы 
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-gray-600">
                  ...
                  Зухра Ильясовна нашла подход к ребенку и вернула интерес к математике."
                </p>
              </CardContent>
            </Card>
          </div>
